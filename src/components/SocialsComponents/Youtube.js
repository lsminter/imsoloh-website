    ...
    <div>
      <a href='https://www.youtube.com/@imsoloh'>
        <div className="flex justify-center">
          <motion.div className="grid place-items-center grid-cols-5 gap-4 text-center border-solid border-2 border-youtube-red p-4" whileHover={{
            scale: .9,
            borderColor:'#05ADAD',
            transition: {
              duration: .2
